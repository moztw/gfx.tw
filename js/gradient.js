	...
	for(i=0;i<objArray.length;i++) {
		...
		if(document.all && !window.opera) {
			...
			for(p=0;p<colorArray.length;p++) {
				...
				g.setAttribute("style","position:absolute;z-index:1;top:" + y + "px;left:" + x + "px;height:" + h + "px;width:" + w + "px;background-color:rgb(" + colorArray[p][0] + "," + colorArray[p][1] + "," + colorArray[p][2] + ");");

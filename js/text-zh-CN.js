var T = {
	...
	ALERT: {
		...
		EXTINSTALL_NOT_FX: '必须要使用 Firefox 系列浏览器才能安装附加组件喔。',
		EXTINSTALL_CHECKED_NOTHING: '您没有选择任何附加组件。',
		...
		EDITOR_GROUP_ERROR: '附加组件分类不是数字。',
		EDITOR_GROUP_EMPTY: '必须要选择一个以上的附加组件分类。',
		EDITOR_ADDON_EMPTY: '您并没有在选择的某个分类内新增附加组件。',
		EDITOR_ADDON_ERROR: '附加组件不是数字。',
	...
	UI: {
		...
		ADDON_DEL: '删除',
		ADDON_SUGGEST_LIST: '或是从下面选择最多人在此属性推荐的附加组件 ...',

	...
	<div class="pageblock">
		...
		<div class="content">
			...
			<div class="col">
				...
				<p>HTML:</p>
				<textarea readonly="readonly">&lt;a href="<?php print site_url($name); ?>" title="連到我的抓火狐推薦頁！"&gt;&lt;img src="<?php print $dir ?>/smallsticker2.png" alt="連到我的抓火狐推薦頁！"/&gt;&lt;/a&gt;</textarea>
				<p>BBCode:</p>
				<textarea readonly="readonly">[url=<?php print site_url($name); ?>][img]<?php print $dir ?>/smallsticker2.png[/img][/url]</textarea>
			</div>
			<div class="desc">
				<h2>橫向貼紙</h2>
				<p><a href="<?php print site_url($name); ?>" title="連到我的抓火狐推薦頁！"><img style="margin: 5px auto; width: auto; height: auto" src="<?php print $dir ?>/featurecard-h.png?<?php print strtotime($modified) ?>" alt="連到我的抓火狐推薦頁！" /></a></p>
				<p>HTML:</p>
				<textarea readonly="readonly">&lt;a href="<?php print site_url($name); ?>" title="連到我的抓火狐推薦頁！"&gt;&lt;img style="margin: 5px auto; width: 200px; height: 250px" src="<?php print $dir; ?>/featurecard-h.png" alt="連到我的抓火狐推薦頁！"/&gt;&lt;/a&gt;</textarea>
				<p>BBCode:</p>

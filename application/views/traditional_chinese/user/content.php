...
<?php } ?>
	...
	<p>喜歡<?php print htmlspecialchars($title) ?>推薦的內容？<a href="<?php print site_url($name) ?>" id="push-plurk"><img src="http://www.plurk.com/favicon.ico" alt="[]" />撲到撲浪</a>或<a href="<?php print site_url($name) ?>" id="push-twitter"><img src="http://twitter.com/favicon.ico" alt="[]" />推到推特</a>！</p>
	</div>
	<div id="groups-title">

...
<head>
	...
	<title>gfx :: <?php print htmlspecialchars($title) ?>'s Firefox promo badge</title>
</head>
<style type="text/css">
html {
	overflow: auto;
...
<body>
<h1><?php print htmlspecialchars($title) ?> would like you to try</h1>
...
<p id="download"><a href="<?php print site_url($name); ?>" onclick="window.open(this.href); return false;">Download Now</a></p>
</body>
</html>